      ...
      <div className="grid md:grid-cols-[320px_1fr] lg:grid-cols-[380px_1fr]">
        ...
        <div className="px-6 md:px-12 lg:px-16 py-14 border-b md:border-b-0 md:border-r border-navy/10">
          <div className="md:sticky md:top-24">
            <p className="font-complement italic text-orange text-xs tracking-[3px] mb-4">
              For Businesses
            </p>
            <h2
              className="font-display text-navy leading-[0.88]"
              style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', letterSpacing: '-0.02em' }}
            >
              COMMERCIAL<br />SECURITY.
            </h2>
            <div className="h-[2px] bg-orange w-8 mt-8 mb-6" />
            <p className="font-complement text-navy/50 text-sm leading-relaxed mb-8 max-w-xs">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-navy text-white px-6 py-3.5 font-display text-[10px] tracking-[3px] hover:bg-orange transition-colors duration-200"
            >
              GET A QUOTE
            </a>
          </div>
          ...
          {FEATURES.map(({ Icon, title, detail }, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-display text-navy text-xs tracking-[2px] mb-2">{title}</h3>
                <p className="font-complement italic text-navy/45 text-sm leading-relaxed">{detail}</p>
              </div>
              <span className="font-display text-navy/10 text-xs self-start mt-1 shrink-0">0{i + 1}</span>
            </div>
          ))}
        </div>
      </div>
